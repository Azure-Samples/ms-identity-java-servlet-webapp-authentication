<%@ page import="com.microsoft.azuresamples.roles.*" %>
<%@ page session="true" %>
<jsp:useBean id="msalAuth" scope="session" class="com.microsoft.azuresamples.roles.MsalAuthSession" />
...
<head>
    ...
    <title>Add authorization using app roles & roles claims to Java servlet Web app that signs-in users with the Microsoft identity platform</title>
</head>
<body>
...
<footer style="text-align: center;">
    ...
    <c:if test = "${msalAuth.getAuthenticated()}">
        <a class="nostyle" href="<c:url value="./survey"></c:url>">
