...
public class AuthHelper {
    ...
    public static void redirectToSignoutEndpoint(final HttpServletRequest req, final HttpServletResponse resp)
        ...
        final String redirect = String.format("%s%s%s%s", AUTHORITY, SIGN_OUT_ENDPOINT,
    ...
    private static void authorize(final HttpServletRequest req, final HttpServletResponse resp)
            throws Exception {
    ...
    private static void acquireTokenSilently(final HttpServletRequest req, final HttpServletResponse resp,
            final IAccount account) throws Exception {
        final MsalAuthSession msalAuth = getMsalAuthSession(req.getSession());
    ...
    private static void redirectToAuthorizationEndpoint(final HttpServletRequest req, final HttpServletResponse resp) throws Exception {
    ...
    private static void processErrorCodes(final HttpServletRequest req, final HttpServletResponse resp) throws Exception {
        ...
        if (error != null || errorDescription != null) {
            throw new Exception(String.format("%s : %s", error, errorDescription));
        }
    }
