...
package com.microsoft.azuresamples.msal4j.roles;
...
public class RoleProtectedPageServlet extends HttpServlet {
    private static Logger logger = Logger.getLogger(RoleProtectedPageServlet.class.getName());
