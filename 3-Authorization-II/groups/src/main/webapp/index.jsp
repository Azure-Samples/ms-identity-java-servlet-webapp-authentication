<%@ page import="com.microsoft.azuresamples.msal4j.helpers.*" %>
<%@ page session="true" %>
...
<head>
    ...
    <title>Authorization: Use MSAL Java to sign in and restrict access to routes based on group membership</title>
</head>
<body>
