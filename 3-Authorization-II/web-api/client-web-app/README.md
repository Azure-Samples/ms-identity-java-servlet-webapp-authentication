...
1. In the **Register an application page** that appears, enter your application's registration information:
   ...
   - In the **Redirect URI** section, select **Web** in the combo-box and enter the following redirect URI: `http://localhost:8080/msal4j-servlet-client/auth/redirect`.
...
4. Find the resulting `.war` file in `./target/msal4j-servlet-client.war` and deploy it to Tomcat or any other J2EE container solution.
...
6. Open your browser and navigate to `http://localhost:8080/msal4j-servlet-client/`
