...
public class Config {
    ...
    "app.protect.authenticated", "aad.scopes", "api.base-address", "api.date-endpoint"}; // scopes required for this sample (User.Read)
    ...
    public static final String API_BASE_ADDRESS = Config.getProperty("api.base-address");
    public static final String API_DATE_ENDPOINT = Config.getProperty("api.date-endpoint");
