...
| <img src="./ReadmeFiles/sign-in.png" width="100"> | [**3.2 Acquire an ID Token with the Groups claim**](./3-Authorization%20II/groups) </br> Enable your web app to acquire an ID Token with a **Groups** claim. Filter access to routes based on the role membership. Learn how to call Graph to handle edge cases where the user is a member of too many groups to fit into an ID Token. |
